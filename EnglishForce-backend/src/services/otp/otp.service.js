...
function genOPTCode() { // 6 chữ số, không có leading zero bug
...
export async function verifyOtp({ email, purpose = 'login', code }) {
  ...
  // limit attempts
  if (record.attempts >= 5) throw new Error('You have entered the wrong password too many times. Please create a new OTP.');
