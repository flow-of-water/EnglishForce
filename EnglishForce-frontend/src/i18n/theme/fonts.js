export const FONT_CONFIG = {
	vi: {
		primary: 'Inter',
		fallbacks: ['Be Vietnam Pro', 'Noto Sans', '-apple-system', 'BlinkMacSystemFont', 'sans-serif'],
	},
	en: {
		primary: 'Roboto',
		fallbacks: ['"Helvetica Neue"', 'Arial', '-apple-system', 'BlinkMacSystemFont', 'sans-serif'],
	},
};
