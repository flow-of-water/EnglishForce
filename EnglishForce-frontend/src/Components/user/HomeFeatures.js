	...
	return (
		...
		>
			...
			<Container sx={{ position: 'relative', zIndex: 1 }}>
				<Stack direction={{ xs: 'column-reverse', md: 'row' }} spacing={6} alignItems="center">
					{/* Image section */}
	...
	return (
		<Box sx={{ backgroundColor: '#ffffff', py: 10 }}>
			<Container maxWidth="lg">
				...
				>
					We blend smart technology and proven methods to deliver an online learning experience that feels
					personal, structured, and effective.
				</Typography>
