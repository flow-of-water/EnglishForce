	...
	return (
		<Container maxWidth="md" sx={{ py: 4 }}>
			<Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
				...
				<Button variant="outlined" onClick={() => navigate(`/admin/units/${unit.public_id}/edit`)}>
					Edit
				</Button>
			</Box>
			...
			<Box sx={{ border: '1px solid gray', borderRadius: 2, p: 2, mb: 4 }}>
				...
				<TextField
					...
					onChange={e => setNewLesson({ ...newLesson, order_index: parseInt(e.target.value, 10) || 0 })}
				/>

				<Button variant="contained" color="primary" onClick={handleCreateLesson} disabled={creating}>
