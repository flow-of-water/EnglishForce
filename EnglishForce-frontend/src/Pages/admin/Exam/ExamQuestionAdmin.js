					...
					<TableBody>
						{questions.map((q, i) => (
							<TableRow key={q.public_id}>
								...
								<TableCell>
									{q.thumbnail ? (
										<a href={q.thumbnail} target="_blank" rel="noreferrer">
											Image
										</a>
									) : (
										'-'
								...
								<TableCell>
									{q.record ? (
										<a href={q.record} target="_blank" rel="noreferrer">
											Audio
										</a>
									) : (
										'-'
								...
								<TableCell>
									<IconButton
										color="info"
										onClick={() => navigate(`/admin/exams/questions/${q.public_id}/answer`)}
									>
										<Visibility />
									</IconButton>
									<IconButton
										color="primary"
										onClick={() => navigate(`/admin/exams/questions/${q.public_id}/edit`)}
									>
										<Edit />
									</IconButton>
