...
import { Box, Typography, Divider, Button, Paper, Stack, Fade } from '@mui/material';
		...
		>
			...
			>
				<Stack spacing={3}>
					...
					<Button variant="contained" size="large" sx={{ borderRadius: 3 }} onClick={() => navigate(-1)}>
						🔙 Back to Unit
					</Button>
				</Stack>
			</Paper>
...
const LessonStartPage = () => {
	...
	if (finished) {
		return <LessonCompleted score={score} exercises={exercises} />;
	}
