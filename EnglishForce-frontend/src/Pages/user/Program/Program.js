...
const ProgramPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        Browse through our curated programs designed to level up your English with a premium learning experience.
      </Typography>
              ...
              <Card
                sx={{
                  ...
                  '&:hover': {
                    ...
                    boxShadow:
                      '0 18px 55px rgba(33,150,243,0.18)',
                  },
                  '&:after': {
                    content: '""',
                    position: 'absolute',
                    ...
                    {program.thumbnail ? (
                      ...
                      <Box
                        sx={{
                          ...
                          background:
                            'linear-gradient(120deg, #e3f2fd, #f3e5f5)',
                        }}
                      >
          ...
          <Grid item xs={12}>
            <Box
              sx={{
                ...
                borderRadius: 4,
                background:
                  'linear-gradient(180deg, #f8fbff, #f9f5ff)',
            ...
            >
              ...
              <Typography color="text.secondary">
                New programs are coming soon. Stay tuned!
              </Typography>
            </Box>
          </Grid>
        )}
