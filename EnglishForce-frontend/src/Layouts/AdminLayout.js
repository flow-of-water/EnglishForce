...
import { AppBar, Toolbar, IconButton, Typography, Box, Button, Avatar, Tooltip } from '@mui/material';
...
const AdminLayout = ({ children }) => {
	...
	return (
		<Box display="flex" flexDirection="column" minHeight="100vh">
			...
			{/* Nội dung chính */}
			<main style={{ marginTop: 64, paddingLeft: 260, padding: '20px', minHeight: '90vh' }}>{children}</main>
			<Footer />
		</Box>
	);
};
